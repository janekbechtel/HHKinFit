...
HHEventRecordSingleH::HHEventRecordSingleH(const HHEventRecordSingleH& eventrecord, TString suffix)
{
...
void
HHEventRecordSingleH::MakeHEvent()
{
  AddInitialEntry(HHPID::MET);
  AddInitialEntry(HHPID::h1);
  DecayChain();
}

HHEventRecordSingleH::~HHEventRecordSingleH()
{
...
Int_t
HHEventRecordSingleH::AddInitialEntry(HHPID::pid pid)
{
...
void
HHEventRecordSingleH::Print(TString name, Int_t mode)
{
...
HHV4Vector*
HHEventRecordSingleH::UpdateEntry(Int_t i)
{
  return m_eventrecord->at(i);
}

HHParticleList*
HHEventRecordSingleH::GetParticleList() const
{
  return m_particlelist;
}

Int_t
HHEventRecordSingleH::AddEntry(HHPID::pid pid, Int_t origin)
{
  HHV4Vector* entry = m_particlelist->GenerateV4(pid);
...
void
HHEventRecordSingleH::DecayChain()
{
...
Int_t
HHEventRecordSingleH::GetNEntries() const
{
  return m_eventrecord->size();
}

HHV4Vector*
HHEventRecordSingleH::GetEntry(Int_t i) const
{
  return m_eventrecord->at(i);
}

void
HHEventRecordSingleH::EventDisplayXY(Int_t style)
...
void
HHEventRecordSingleH::Recombine()
{
...
void
HHEventRecordSingleH::UpdateMothers(Int_t ivdaughter)
{
